...
from pets.views import HomeView, PetCreateView, PetsListView, PetDetailView, CalenderListView, AppointmentCreateView
...
urlpatterns = [
    ...
    path('calender/', CalenderListView.as_view(), name='calender-list-page'),
